...
from sudokuBackend.settings import BASE_DIR
import os
...
# main
model = train(os.path.join(BASE_DIR, 'solverREST/solverSRC/numbers_samples.data'), os.path.join(BASE_DIR, 'solverREST/solverSRC/numbers_responses.data'))
